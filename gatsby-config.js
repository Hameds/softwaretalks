...
module.exports = {
  siteMetadata: {
    ...
    platforms: {
      ...
      twitch: 'https://twitch.tv/softwaretalks',
      overcast: 'https://overcast.fm/itunes1453189955/softwaretalks',
      spotify: 'https://spotify.com/softwaretalks',
      podcast: 'https://podcasts.apple.com/podcast/id1453189955',
      github: 'https://github.com/softwaretalks',
      virgool: 'https://virgool.io/softwaretalks',
      twitter: 'https://twitter.com/softwaretalks',
      instagram: 'https://instagram.com/softwaretalks',
    },
  },
  plugins: [
    {
